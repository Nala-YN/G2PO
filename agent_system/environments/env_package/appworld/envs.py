...
class AppWorldWorker:
    ...
    def step(self, action):
        ...
        if "..." in action:
            obs="Execution failed. You are not allowed to use ellipsis in your code."
        elif "except" in action.lower():
            obs="Execution failed. You are not allowed to use try-except in your code."
        else:
            try:
                ...
                obs = "Execution failed due to timeout or error."
...
class AppWorldEnvs:
    ...
    def __init__(self, 
        ...
        self.task_ids = load_task_ids(dataset_name,difficulty=1) + load_task_ids(dataset_name,difficulty=2)
